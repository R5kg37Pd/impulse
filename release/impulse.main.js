    ...
    var e = {
        ...
        125: (e, t, a) => {
            ...
            class s {
                ...
                shellsTeleport = (e, t) => {
                    const a = this.#e.shellsTeleportData,//婓腔渣昫
        ...
        580: (e, t, a) => {
            ...
            class i {
                ...
                constructor() {
                    ...
                    this.data.otherData.showAlert && (this.data.otherData.showAlert = !1, alert("妒扼扭抉抖抆戒批抄找快 找抉抖抆抗抉 扶忘 找快扼找抉志抉技 扼快把志快把快 我 找抉抖抆抗抉 志 把快忪我技快 扭忘把抗批把!\nUse only on the test server and only in parkour mode!")), this.saveStates()
                }
            }
        },
        600: (e, t, a) => {
        ...
        227: (e, t, a) => {
            ...
            //            if (!document.URL.includes("test-eu.tankionline.com")) throw alert("躺盓厥聆彸督ㄐ"), new Error("stop");
            //            if ("0.64.3" !== GM_info.script.version) throw alert("孝 志忘扼 批扼找忘扶抉志抖快扶忘 批扼找忘把快志扮忘攸 志快把扼我攸 扼抗把我扭找忘!\nYou have an outdated version of the script installed!"), unsafeWindow.open("https://raw.githubusercontent.com/sheezzmee/impulse/main/impulse.user.js", "_self"), new Error("stop");
            ! function e() {
